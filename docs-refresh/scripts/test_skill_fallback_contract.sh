...
assert_contains "$repo_root/README.md" 'ad hoc custom docs folders should be decomposed into the standard domains and their prior contents preserved under `old_docs/`'
