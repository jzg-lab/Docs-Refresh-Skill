...
assert_contains "$skill_dir/SKILL.md" 'that repair work is mandatory'
...
assert_contains "$skill_dir/modes/repair.md" 'Empty `doc_review_triggers` does not downgrade a repair finding.'
