...
assert_contains "$skill_dir/SKILL.md" '`repo_taxonomy_mode`, `taxonomy_health`, `role_map`, `normalization_candidates`, `migration_candidates`, `plan_readiness`, and `active_plan_target` as the routing contract'
...
assert_contains "$skill_dir/agents/openai.yaml" '`repo_taxonomy_mode`, `taxonomy_health`, `role_map`, `normalization_candidates`, `migration_candidates`, `plan_readiness`, and `active_plan_target` as the routing contract'
...
assert_contains "$repo_root/README.md" '`repo_taxonomy_mode`, `taxonomy_health`, `role_map`, `normalization_candidates`, `migration_candidates`, `plan_readiness`, and `active_plan_target` as the routing contract'
