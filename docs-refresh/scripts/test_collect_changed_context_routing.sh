...
assert_line "$output" "validation_state=missing"
assert_line "$output" "foundation_gaps=problem-frame,validation-plan"
assert_line "$output" "repair_targets=docs/design-docs/index.md"
assert_line "$output" "doc_review_triggers=navigation"
assert_line "$output" "doc_refresh_hint=repair-map-before-content"
...
output="$(assert_routing "$repo" "repair" "missing-split-doc-indexes")"
assert_line "$output" "repair_targets=docs/exec-plans/index.md"
...
assert_line "$output" "repair_targets=docs/exec-plans/active/,docs/exec-plans/completed/"
assert_line "$output" "missing_index_targets="
